...
let
  project = haskell-nix.project {
    ...
    sha256map = {
      "https://github.com/input-output-hk/plutus-apps.git"."ce8282d89939852ef752eec43565d5e68715e62d" = "0px89sjqhqdk7p1gh8hqq5n1vhly7qs1f9v6mdvzcyc7d0aljg9y";
      ...
      "https://github.com/blockfrost/blockfrost-haskell"."f57e30b185e361ce889510df678558a22b31e84e" = "0ix8wxvnqnwk7bs15kvhynaxfl0337knsb9d3gd93yaiz5gc1kwm";
    };
